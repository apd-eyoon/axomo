...
namespace StoreCreditor.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AxomoCreditId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IssuedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    IssuedByJob = table.Column<bool>(type: "bit", nullable: false),
                    Success = table.Column<bool>(type: "bit", nullable: false),
                    FailureReason = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeCreditHistory", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "EmployeeStaging",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    Division = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeStaging", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_Category_Action",
                table: "AuditLog",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCreditHistory_EmployeeId_Description_Success",
                table: "EmployeeCreditHistory",
                columns: new[] { "EmployeeId", "Description", "Success" },
                unique: true,
                filter: "[Success] = 1");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeStaging_EmployeeId",
                table: "EmployeeStaging",
                column: "EmployeeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeStaging_Processed_IsActive",
                table: "EmployeeStaging",
                columns: new[] { "Processed", "IsActive" });
        }
